...
const tokens: Token[] = [
  { symbol: "ZRA", name: "Zyra", icon: "💎", mint: "3Jz9qH8kB8EyJJu8W1Mj5AS4GX54xJFfcnNNuWZ35bZE", decimals: 9 },
        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass rounded-2xl p-4 space-y-1 gradient-border">
            ...
            {!user ? (
              ...
              <Button className="w-full mt-3 h-12 text-base font-semibold glow-sm" size="lg" onClick={() => openWalletConnect()}>
